...
class MongoDBClient:
    """
    Using MongoDBClient for establishing connections to the MongoDB database.
    ...
    def __init__(self,database_name: str = DATABASE_NAME) -> None:
        ...
        -------
        MyException
                If the is an issue connecting to MongoDB or if the environment variable for the MongoDB URL is not set.
        """
        try:
